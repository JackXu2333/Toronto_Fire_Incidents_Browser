...
saveRDS(fire_incidents_trimmed, "data/Trimmed_Fire_Incidents.Rds")

```

```{r fire_station}

fireStation <- read.csv("data/Fire_Station_Locations.csv", header = T)
...
neighbourhood_Shape <- readRDS("data/neighbourhood_shapefile.Rds")
